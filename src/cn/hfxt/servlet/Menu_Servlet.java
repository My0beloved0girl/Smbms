...
public class Menu_Servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Menu> seleMenuAn = new MenuServiceImpl().seleMenuAn(Integer.parseInt(request.getParameter("id")));
		
		request.setAttribute("an", seleMenuAn);
		request.getRequestDispatcher("quan.jsp").forward(request, response);
