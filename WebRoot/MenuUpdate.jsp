...
<head>
	...
	<link rel="stylesheet" href="<%=basePath %>/layui/css/layui-v2.5.5/css/layui.css" media="all" />
	<link rel="stylesheet" href="<%=basePath %>/layui/css/public.css" media="all" />
</head>
...
<div class="layui-form">
	...
	<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-input-block">
			<input type="text" class="layui-input userName" id="mfid" lay-verify="uname" placeholder="请输入请求标识">
		</div>
	</div>
	<!-- 请求地址servlet -->
	<div class="layui-form-item layui-row layui-col-xs12">
	...
	<!-- 当前按钮样式 -->
	<div class="layui-form-item layui-row layui-col-xs12" id="btn" style="display:none;">
		<!-- 按钮样式 -->
		<div class="layui-form-item layui-row layui-col-xs12">
			<label class="layui-form-label">当前样式</label>
			<div class="layui-input-block"  id="NowbtnType">
...
<script type="text/javascript" src="<%=basePath %>/layui/css/layui-v2.5.5/layui.js"></script>
<script type="text/javascript" src="<%=basePath %>/js/MenuUpdate.js"></script>
</body>
</html>